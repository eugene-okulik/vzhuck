...
class Book:
    ...
    def printBook(self):
        if self.reserv:
            print(f"Название: {self.book_name}, Автор: {self.author}, страниц: {self.pages}, материал: {self.material_pages}, зерезервирована")
        else:
            print(f"Название: {self.book_name}, Автор: {self.author}, страниц: {self.pages}, материал: {self.material_pages}")
...
class SchoolBooks(Book):
    ...
    def printBook(self):
        if self.reserv:
            print(f"Название: {self.book_name}, Автор: {self.author}, страниц: {self.pages}, предмет: {self.lesson}, класс: {self.grade}, зерезервирована")
        else:
            print(f"Название: {self.book_name}, Автор: {self.author}, страниц: {self.pages}, предмет: {self.lesson}, класс: {self.grade}")
